...
import { listAdminUsers } from "@/lib/wpp/users-server";
...
export default async function AdminUsersPage() {
  ...
  const users = await listAdminUsers(session?.sub ?? "");
    ...
    <div style={{ minHeight: "100vh", background: WPP_T.panel, fontFamily: WPP_FONTS.sans }}>
      ...
      <main style={{ padding: 32, maxWidth: 820 }}>
        ...
        <p style={{ fontSize: 14, color: WPP_T.mute, margin: "0 0 20px" }}>
          Everyone who can sign in to this panel. Adding someone, or resetting a
          forgotten password, produces a temporary password shown once — pass it on
          directly and ask them to change it under Account.
        </p>
